define(function (require) {
  return function ChloroplethpolyFactory(Private) {
     ...
     */
    _.class(Chloroplethpoly).inherits(BaseMarker);
    function Chloroplethpoly(map, geoJson, params) {
      var self = this;
      Chloroplethpoly.Super.apply(this, arguments);
     ...
     * @return {Number}
     */
    Chloroplethpoly.prototype._geohashMinDistance = function (feature) {
